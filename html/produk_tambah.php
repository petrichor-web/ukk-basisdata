...
if(isset($_POST['namaproduk']) && isset($_POST['harga']) && isset($_POST['stok'])) {
    ...
    if($result) {
        echo '<script>alert("Tambah Data Berhasil"); window.location.href="produk.php";</script>';
    } else {
...
<nav
        ...
        >
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
                      ...
                      <div class="card">
                <h5 class="card-header fw-bold">Table Tambah Produk</h5>
                
                <div class="table-responsive text-nowrap">
                  <a href="Produk.php" class="btn btn-danger ms-3">kembali</a>
                  <hr>
