...
if(isset($_POST['namapelanggan']) && isset($_POST['alamat']) && isset($_POST['nomortelepon'])) {
    // Ambil data dari form dan hindari SQL Injection
    $nama = mysqli_real_escape_string($koneksi, $_POST['namapelanggan']);
    $alamat = mysqli_real_escape_string($koneksi, $_POST['alamat']);
    $nomertelepon = mysqli_real_escape_string($koneksi, $_POST['nomortelepon']);

    // Query untuk insert data
    $query = "INSERT INTO pelanggan (namapelanggan, alamat, nomortelepon) VALUES ('$nama', '$alamat', '$nomertelepon')";
    $result = mysqli_query($koneksi, $query);

    if($result) {
        echo '<script>alert("Tambah Data Berhasil"); window.location.href="Pelanggan.php";</script>';
    } else {
...
<nav
        ...
        >
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
                      ...
                      <div class="card">
                <h5 class="card-header fw-bold">Table Tambah Pelanggan</h5>
