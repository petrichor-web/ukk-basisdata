...
<nav
        ...
        >
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
                      ...
                      <div class="card">
                      <h5 class="card-header fw-bold">Table Pelanggan</h5>
                
                <div class="table-responsive text-nowrap">
                  <a href="pelanggan_tambah.php" class="btn btn-primary ms-3">Tambah Data</a>
                  <hr>
                  </div>
                  <table class="table">
                    <thead>
                    ...
                    <?php 
                      ...
                      while($data = mysqli_fetch_array($query)){
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="pelanggan_ubah.php?pelangganID=<?php echo $data['pelangganID']; ?>" class="btn btn-secondary">Ubah</a>
                            <a href="pelanggan_hapus.php?pelangganID=<?php echo $data['pelangganID']; ?>" class="btn btn-danger">Hapus</a>
                          </td>
                        </tr>
                        <?php
                      }
