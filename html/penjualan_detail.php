...
$query = mysqli_query($koneksi, "SELECT penjualan.*, pelanggan.namapelanggan FROM penjualan LEFT JOIN pelanggan ON pelanggan.pelangganID = penjualan.pelangganID WHERE penjualanID=$id");    
$data  = mysqli_fetch_array($query);

// Fetch cash and change from detailpenjualan if available
$detailQuery = mysqli_query($koneksi, "SELECT tunai, kembalian FROM detailpenjualan WHERE penjualanID = $id");
$detailData = mysqli_fetch_array($detailQuery);
$tunai = $detailData['tunai'] ?? 0;
$kembalian = $detailData['kembalian'] ?? 0;
?>
...
<nav
        ...
        >
          ...
          <h4 style="margin-top: 10px;">Pembelian</h4>
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
                      ...
                      <div class="card">
                <h5 class="card-header fw-bold">Table Pembelian</h5>
                <div class="table-responsive text-nowrap">
                  <a href="Penjualan.php" class="btn btn-danger ms-3">kembali</a>
                  <button id="downloadImage" class="btn" style="background-color: #7c42da; color: white; border-radius: 10px;">Download sebagai JPG</button>
                  <hr>
                  
                  <form method="post" id="detailContainer">
                    <table class="table table-bordered">
                    <h2 style="text-align: center; margin-top: 20px;">
                        <img src="../assets/img/whale.png" alt="Logo" style="height: 40px; vertical-align: middle; margin-right: 10px;">
                        FOOD
                    </h2>
...
document.getElementById("downloadImage").addEventListener("click", function() {
    ...
    html2canvas(element).then(canvas => {
        ...
        link.download = "detail_pembelian.jpg"; // Nama file
        link.click();
    });
});
</script>
