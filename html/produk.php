<?php
// session_start();
include "koneksi.php"; // Pastikan file koneksi ini ada dan berfungsi
...
<nav
        ...
        >
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                <h5 class="card-header fw-bold">Table Produk</h5>
                <div class="table-responsive text-nowrap">
                  <a href="produk_tambah.php" class="btn btn-primary ms-3">Tambah Data</a>
                  <hr>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    <thead>
                      ...
                      while($data = mysqli_fetch_array($query)){
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="produk_ubah.php?produkID=<?php echo $data['produkID']; ?>" class="btn btn-secondary">Ubah</a>
                            <a href="produk_hapus.php?produkID=<?php echo $data['produkID']; ?>" class="btn btn-danger">Hapus</a>
