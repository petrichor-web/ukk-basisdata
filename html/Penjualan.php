        ...
        >
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="table-responsive text-nowrap">
                  <a href="penjualan_tambah.php" class="btn btn-primary ms-3">Tambah Data</a>
                  <hr>
                  </div>
                  <table class="table">
                    <thead>
                      ...
                      <?php 
                        $query = mysqli_query($koneksi, "SELECT penjualan.*, pelanggan.namapelanggan FROM penjualan LEFT JOIN pelanggan ON pelanggan.pelangganID = penjualan.pelangganID");                     
                        ...
                        <tr>
                          ...
                          <td>
                          <a href="penjualan_detail.php?penjualanID=<?php echo $data['penjualanID']; ?>" class="btn btn-secondary">Detail</a>
                            <a href="penjualan_hapus.php?penjualanID=<?php echo $data['penjualanID']; ?>" class="btn btn-danger">Hapus</a>
                          </td>
                        </tr>
                        <?php
                      }
